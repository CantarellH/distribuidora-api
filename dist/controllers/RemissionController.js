...
exports.deleteRemission = exports.updateRemission = exports.filterRemissions = exports.getRemissionById = exports.getRemissions = exports.createRemission = void 0;
...
const createRemission = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const client = yield data_source_1.AppDataSource.getRepository(Client_1.Client).findOneBy({ id: clientId });
        if (!client) {
        ...
        const detailRepository = data_source_1.AppDataSource.getRepository(RemissionDetail_1.RemissionDetail);
        const processedDetails = yield Promise.all(details.map((detail) => __awaiter(void 0, void 0, void 0, function* () {
            const { eggTypeId, boxCount, weightTotal, supplierId } = detail;
            const eggType = yield data_source_1.AppDataSource.getRepository(EggType_1.EggType).findOneBy({ id: eggTypeId });
            if (!eggType)
                throw new Error(`Tipo de huevo con id ${eggTypeId} no encontrado.`);
            const supplier = yield data_source_1.AppDataSource.getRepository(Supplier_1.Supplier).findOneBy({ id: supplierId });
            if (!supplier)
            ...
            return yield detailRepository.save(newDetail);
        })));
